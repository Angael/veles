...
- For simple static query invalidation after mutation, prefer `useMutation` `meta.invalidateQueryKey`
...
- Use `TypedFormData` from `apps/web/src/components/typed-form/TypedFormData.ts` instead of reading raw `FormData` values.

...
This skill requires familiarity with both TanStack Router and TanStack Query. Read [router-core](skill://router-core) and [react-router](skill://react-router) first.

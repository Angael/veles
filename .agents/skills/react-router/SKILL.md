...
This skill builds on router-core. Read [router-core](skill://router-core) first for foundational concepts.
...
- [router-core](skill://router-core) — all sub-skills for domain-specific patterns (search params, data loading, navigation, auth, SSR, etc.)
